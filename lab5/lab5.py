...
#         # Step 1: replace terminals in productions with >1 symbols
#         terminal_map = {}
#         counter = 1
...
#         # Step 2: convert long productions into binary productions
#         def binarize(prod):
#             if len(prod) <= 2:
#                 return [prod]
#             result = []
...
# # === Example Grammar from your variant ===
